...
--tee outputCount=7 \
  ...
  --b --tee outputCount=34 \
    ...
    --bb top=7.994 left=81.344 bottom=7.226 right=81.981 \
    --tee outputCount=2 --wx file=ex/batticaloa.osm.bz2 --wb file=ex/batticaloa.osm.pbf \
    ...
    --bb top=32.300 left=76.123 bottom=31.970 right=76.701 \
    --tee outputCount=2 --wx file=ex/dharamshala.osm.bz2 --wb file=ex/dharamshala.osm.pbf \
    --bb top=7.236 left=79.756 bottom=6.737 right=80.385 \
    --tee outputCount=2 --wx file=ex/colombo.osm.bz2 --wb file=ex/colombo.osm.pbf \
    --bb top=24.006 left=89.998 bottom=23.435 right=90.838 \
    --tee outputCount=2 --wx file=ex/dhaka.osm.bz2 --wb file=ex/dhaka.osm.pbf \
    ...
    --bb top=23.106 left=87.751 bottom=22.117 right=89.119 \
    --tee outputCount=2 --wx file=ex/kolkata.osm.bz2 --wb file=ex/kolkata.osm.pbf \
  ...
  --b --tee outputCount=70 \
    ...
    --bb top=43.500 left=-3.363 bottom=43.043 right=-2.555 \
    --tee outputCount=2 --wx file=ex/bilbao.osm.bz2 --wb file=ex/bilbao.osm.pbf \
    ...
    --bb top=44.729 left=25.542 bottom=44.141 right=26.756 \
    --tee outputCount=2 --wx file=ex/bucharest.osm.bz2 --wb file=ex/bucharest.osm.pbf \
    ...
    --bb top=43.800 left=-6.481 bottom=43.054 right=-4.987 \
    --tee outputCount=2 --wx file=ex/gijon.osm.bz2 --wb file=ex/gijon.osm.pbf \
    ...
    --bb top=38.295 left=12.912 bottom=37.771 right=13.845 \
    --tee outputCount=2 --wx file=ex/palermo.osm.bz2 --wb file=ex/palermo.osm.pbf \
    ...
    --bb top=43.713 left=39.548 bottom=43.314 right=40.178 \
    --tee outputCount=2 --wx file=ex/sochi.osm.bz2 --wb file=ex/sochi.osm.pbf \
    ...
    --bb top=61.674 left=23.214 bottom=61.325 right=24.310 \
    --tee outputCount=2 --wx file=ex/tampere.osm.bz2 --wb file=ex/tampere.osm.pbf \
  ...
  --bb top=11.442 left=-78.853 bottom=-34.966 right=-42.850 \
  --b --tee outputCount=13 \
    ...
    --bb top=11.442 left=-63.136 bottom=9.443 right=-60.224 \
    --tee outputCount=2 --wx file=ex/trinidad-tobago.osm.bz2 --wb file=ex/trinidad-tobago.osm.pbf;
